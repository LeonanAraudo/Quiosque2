...
import useCreateShake from "../../../../../hook/CreateShake/hook";

export default function OptionsShake({ comanda_id }) {
    const [isButtonDisabled, setIsButtonDisabled] = useState(false);
    const { register, handleSubmit, onSubmit } = useCreateShake({ comanda_id });
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                ...
                <div className="mt-5">
                    ...
                    <div className="flex flex-row justify-between mx-10  mt-4">
                        ...
                        {["Tradicional", "Abacate", "Beijinho", "Chocolate", "Morango Azedo","Morango doce", "Açai", "Oreo", "Chocolate Branco"].map((sabor, index) => (
                        ...
                        <div className="flex flex-col gap-3">
                            {["Abacaxi", "Ovomaltine","Menta", "Babalu", "Maracujá", "Maçã Verde","Banana", "Leite Condensado"].map((sabor, index) => (
