...
export default function OptionsPedidos() {
    ...
    return (
        <div className="w-full h-auto mt-16 flex items-center justify-center flex-col gap-7">
            <button onClick={handleMesas} className={`flex justify-center items-center flex-row bg-orange-700 gap-3 text-white text-center text-[20px] w-[95%] h-[60px] rounded-[10px] ${roboto.className}`}>
             Mesas
            <span>
                            <img width="30" height="30" src="https://img.icons8.com/ios/50/FFFFFF/table.png" alt="tables" />
                        </span>
           </button>
